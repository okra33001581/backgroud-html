...
// 获取列表
export function userIndex(query) {
    return axios({
        url: "http://apidemo.test/api/event/userIndex",
        method: "get",
        params: query
});
}
...
// 获取角色列表
export function userLoginIpsIndex(query) {
    return axios({
        url: "http://apidemo.test/api/event/userLoginIpsIndex",
        method: "get",
        params: query
    });
}
...
// 获取角色列表
export function userPrizeSetsIndex(query) {
    return axios({
        url: "http://apidemo.test/api/event/userPrizeSetsIndex",
        method: "get",
        params: query
    });
}

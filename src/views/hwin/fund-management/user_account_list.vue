    ...
    <div>
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="formRules" ref="dataForm">
                ...
                <el-form-item label="商户名称" prop="merchant_name"><el-input v-model="formData.merchant_name" auto-complete="off"></el-input></el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            auditItemServer(row,flag) {
                ...
                // debugger
                userAccountsStatusSave(params).then(
                    function (res) {
                        // debugger
                        if(res.code === 1){
                            this.$message({

<template>
    ...
    <div>
        <el-form :inline="true" :model="query" class="query-form" size="mini">
            ...
            <el-form-item class="query-form-item">
                <el-select v-model="query.in_account" placeholder="收款账号">
                    <el-option label="全部" value=""></el-option>
                </el-select>
            </el-form-item>

            <el-form-item class="query-form-item">
                <el-select v-model="query.select_search_type" placeholder="会员账号">
                    <el-option label="全部" value=""></el-option>
                    <el-option label="会员账号" value="会员账号"></el-option>
                    <el-option label="订单账号" value="订单账号"></el-option>
        ...
        <el-dialog
                ...
                width="85%"
                top="5vh">
            <el-form :model="formData" label-width="6%" :rules="formRules" ref="dataForm">
                ...
                <el-form-item label="			收款账号		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                ...
                <el-form-item label="			充值金额		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			实际入款		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			申请日期		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			确认日期		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            itemSuccessServer(index, row) {
                ...
                // debugger
                fastpaymoneyStatusSave(params).then(
                    function (res) {
                        // debugger
                        /*if(res.code === 1){
                            this.$message({

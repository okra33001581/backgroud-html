<template>
    ...
    <div>
        <el-form :inline="true" :model="query" class="query-form" size="mini">
            ...
            <el-form-item class="query-form-item">
                <el-select v-model="query.status" placeholder="入款账号">
                    <el-option label="全部" value=""></el-option>
                </el-select>
            </el-form-item>
            ...
            <el-form-item class="query-form-item">
                <el-select v-model="query.status" placeholder="状态">
                    ...
                    <el-option label="存款人" value="1"></el-option>
                    <el-option label="附言码" value="2"></el-option>
        ...
        <el-table
            ...
            <el-table-column label="					申请金额		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					入款优惠		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					附言码		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					充值订单尾号		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					存入银行账号		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					申请时间		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					确认时间		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					操作人		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					状态		" prop="id" align="center" sortable="custom" fixed></el-table-column>
            <el-table-column label="					备注		" prop="id" align="center" sortable="custom" fixed></el-table-column>
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="formRules" ref="dataForm">
                ...
                <el-form-item label="			存款人姓名/昵称		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			申请金额   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			入款优惠   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			附言码       		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			充值订单尾号 		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			存入银行账号 		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>

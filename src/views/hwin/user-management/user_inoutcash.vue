...
-->
            ...
            <el-table-column label="					注册时间		" prop="register_date" fixed></el-table-column>
            <el-table-column label="					登录时间		" prop="login_date" fixed></el-table-column>
            <el-table-column label="					用户名		" prop="username" fixed></el-table-column>
            <el-table-column label="					用户类型		" prop="user_type" fixed></el-table-column>
            ...
            <el-table-column label="					账户余额		" prop="final_amount" fixed></el-table-column>
            <el-table-column label="					存款次数		" prop="deposit_count" fixed></el-table-column>
            <el-table-column label="					提款次数		" prop="withdraw_count" fixed></el-table-column>
            <el-table-column label="					存款总数		" prop="deposit_amount" fixed></el-table-column>
            <el-table-column label="					提款总数		" prop="withdraw_amount" fixed></el-table-column>
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="formRules" ref="dataForm">
                ...
                <el-form-item label="			注册时间   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			登录时间   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			用户名       		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			用户类型   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			一级代理   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                ...
                <el-form-item label="			存款次数   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			提款次数   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			存款总数   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			提款总数   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>

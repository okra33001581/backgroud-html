    ...
    <div>
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="formRules" ref="dataForm">
                ...
                <el-form-item label="			有效会员   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			新增用户   		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			总存款       		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>
                <el-form-item label="			总出款       		" prop="username"><el-input v-model="formData.username" auto-complete="off"></el-input></el-form-item>

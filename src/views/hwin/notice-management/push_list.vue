<template>
    ...
    <div>
        <el-form :inline="true" :model="query" class="query-form" size="mini">
            ...
            <el-form-item class="query-form-item">
                <el-select v-model="query.status" placeholder="推送类型">
                    <el-option label="全部" value=""></el-option>
                    <el-option label="广播通知" value="0"></el-option>
                    <el-option label="优惠活动" value="1"></el-option>
                    <el-option label="维护通知" value="2"></el-option>
                </el-select>
            </el-form-item>
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="formRules" ref="dataForm">
                ...
                <el-form-item label="推送类型" prop="username">
                    <el-input v-model="formData.username" auto-complete="off"></el-input>
                </el-form-item>

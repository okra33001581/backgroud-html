...
<script>
    import {
        merchantsDomains,
        authAdminRoleList,
        merchantsDomainsSave,
        merchantsDomainsStatusSave,
        merchantsDomainsDel
    ...
    export default {
        ...
        methods: {
            ...
            auditItemSubServer(row,flag) {
                ...
                // debugger
                merchantsDomainsStatusSave(params).then(
                    function (res) {
                        // debugger
                        if(res.code === 1){
                            this.$message({
            ...
            merchantsDomainsStatusSave(row) {
                var params = {
                    id: row.id,
            ...
            formSubmit() {
                this.$refs["dataForm"].validate(valid => {
                    if (valid) {
                        ...
                        merchantsDomainsSave(data, this.formName).then(response => {

    ...
    <div>
        ...
        <el-dialog
            ...
            <el-form :model="formData" label-width="12%" :rules="formRules" ref="dataForm">
                ...
                <el-form-item label="parent_level" prop="parent_level">
                    <el-input v-model="formData.parent_level" auto-complete="off"></el-input>
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            auditItemSubServer(row,flag) {
                ...
                // debugger
                merchantsIpStatusSave(params).then(
                    function (res) {
                        // debugger
                        if(res.code === 1){
                            this.$message({
            ...
            formSubmit() {
                this.$refs["dataForm"].validate(valid => {
                    if (valid) {
                        ...
                        merchantsIpSave(data, this.formName).then(response => {

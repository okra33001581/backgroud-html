        ...
        <el-dialog
            ...
            <el-form :model="formData" label-width="5%" :rules="formRules" ref="dataForm">
               ...
               <el-form-item label="部门名称" prop="title">
                ...
                <el-form-item label="描述" prop="ruleFormat">
...
<script>
    import {
        permissionRuleDeptIndex,
        permissionRuleDeptTree,
        permissionRuleDeptSave,
        ruleDeptStatusSave,
        permissionRuleDeptDelete
    ...
    export default {
        ...
        methods: {
            ...
            itemDelServer(index, row) {
                var params = {
                    id: row.id,
                }
                // debugger
                permissionRuleDeptDelete(params).then(
                    function (res) {
                        // debugger
                        /*if(res.code === 1){
                            this.$message({
            ...
            formSubmit() {
                this.$refs["dataForm"].validate(valid => {
                    if (valid) {
                        ...
                        permissionRuleDeptSave(data, this.formName)
                            .then(response => {

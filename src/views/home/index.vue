    ...
    <el-container class="wrapper">
        ...
        <el-container class="container-box" v-bind:class="{'slide-hide': isCollapse, 'slide-in-left': menuShow}">
            <el-header class="header">
                ...
                <div class="header-tabs-middle">
                    <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
                        <el-menu-item index="1"><img
                                src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1548848132312&di=6c64711d803871a0654003d53b70803c&imgtype=0&src=http%3A%2F%2Fbpic.588ku.com%2Felement_origin_min_pic%2F01%2F53%2F29%2F265746caa127189.jpg"
                                width="50px" height="30px"></img>
                        </el-menu-item>
                        <el-submenu index="2">
                            <template slot="title"><img
                                    src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1548848132312&di=6c64711d803871a0654003d53b70803c&imgtype=0&src=http%3A%2F%2Fbpic.588ku.com%2Felement_origin_min_pic%2F01%2F53%2F29%2F265746caa127189.jpg"
                                    width="50px" height="30px"></img></template>

<template>
    <el-container class="wrapper">
        <el-header class="header" style="padding-left: 20px; color: white; background-color: rgb(105, 89, 205);">
            ...
            <div class="header-middle">
                <el-dropdown trigger="click">
                    ...
                    <span style="color: white;">Fund</span><i class="el-icon-arrow-down el-icon--right"></i>

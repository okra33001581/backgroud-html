<template>
    ...
    <div>
        ...
        <el-table
            ...
            <el-table-column label="			中文标题				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			资金流				" prop="id" sortable="custom" fixed></el-table-column>
            ...
            <el-table-column label="			关联注单				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			关联追号				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			反向类型				" prop="id" sortable="custom" fixed></el-table-column>

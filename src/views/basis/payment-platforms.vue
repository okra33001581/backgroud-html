<template>
    ...
    <div>
        ...
        <el-table
            ...
            <el-table-column label="			显示名称 				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			注册天数限定规则				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			充值次数限定规则				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			分类名称				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			状态				" prop="id" sortable="custom" fixed></el-table-column>
            <el-table-column label="			默认				" prop="id" sortable="custom" fixed></el-table-column>
            ...
            <el-table-column label="			充值返还百分比 				" prop="id" sortable="custom" fixed></el-table-column>
